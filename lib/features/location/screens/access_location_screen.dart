          ...
          child: SizedBox(
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              addressController.addressList != null ? addressController.addressList!.isNotEmpty ? ListView.builder(
                ...
                padding: ResponsiveHelper.isDesktop(context) ? const EdgeInsets.symmetric(horizontal: Dimensions.paddingExtraLarge, vertical: Dimensions.paddingSmall) : const EdgeInsets.all(Dimensions.paddingDefault),
              ...
              SizedBox(height: (addressController.addressList != null && addressController.addressList!.length < 4) ? 200 : Dimensions.paddingLarge),
