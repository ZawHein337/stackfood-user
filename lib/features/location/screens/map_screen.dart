      ...
      body: Center(
        child: SizedBox(
          ...
          child: Stack(children: [
            ...
            Positioned(
              left: Dimensions.paddingLarge, right: Dimensions.paddingLarge, bottom: Dimensions.paddingLarge,
              child: Column(
                children: [
                  ...
                  widget.fromDineInOrder ? SizedBox() : Align(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.my_location_outlined, color: context.primary, size: 25),
                      ),
                    ),
                  ),
                  ...
                  widget.restaurant != null ? RestaurantDetailsSheetWidget(
                    ...
                    child: Container(
                      ...
                      child: widget.fromRestaurant ? Row(children: [
                        ...
                        Expanded(
                          child: Text(widget.address.address ?? '', style: context.subHeading.defaultSize.medium, maxLines: 2, overflow: TextOverflow.ellipsis),
                        ),
                          ...
                          Row(children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                Text(widget.address.addressType!.tr, style: context.body.small.regular.overrideWith(color: context.textBaseMedium)),

                                Text(widget.address.address!, style: context.subHeading.defaultSize.medium),

                                (widget.address.road != null && widget.address.road!.isNotEmpty) ? Text('${'street_number'.tr}: ${widget.address.road}', style: context.subHeading.defaultSize.medium) : const SizedBox.shrink(),
                                (widget.address.house != null && widget.address.house!.isNotEmpty) ? Text('${'house'.tr}: ${widget.address.house}', style: context.subHeading.defaultSize.medium) : const SizedBox.shrink(),
                                (widget.address.floor != null && widget.address.floor!.isNotEmpty) ? Text('${'floor'.tr}: ${widget.address.floor}', style: context.subHeading.defaultSize.medium) : const SizedBox.shrink(),

                              ]),
                            ),
                          ]),

                          Text('- ${widget.address.contactPersonName}', style: context.subHeading.large.medium.overrideWith(color: context.primary)),

                          Text('- ${widget.address.contactPersonNumber}', style: context.subHeading.defaultSize.regular),
