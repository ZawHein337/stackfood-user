...
class BottomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(child: SizedBox(width: 700, child: Padding(
      padding: context.width > 700 ? const EdgeInsets.all(0) :  const EdgeInsets.all(Dimensions.paddingExtraLarge),
        ...
        TextButton(
          style: TextButton.styleFrom(
            shape: RoundedRectangleBorder(
              side: BorderSide(width: 2, color: context.primary),
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Padding(
              ...
              child: Icon(Icons.map, color: context.primary),
            ),
            Text('set_from_map'.tr, textAlign: TextAlign.center, style: context.body.large.strong.overrideWith(color: context.primary)),
          ]),
        ),
