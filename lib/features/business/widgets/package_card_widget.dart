          ...
          builder: (context) {
            return Container(
              ...
              decoration: BoxDecoration(
                color: canSelect ? const Color(0xff334257) : context.surfaceContainer,
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                border: Border.all(color: Colors.black12, width: 0.5),
                boxShadow: canSelect ? [BoxShadow(color: context.shadow, spreadRadius: 1, blurRadius: 5)] : null,
              ),
            );
          }
        ),
        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            Text(
              ...
              style: context.heading.large.strong.overrideWith(color: canSelect ? context.surfaceContainer : const Color(0xff334257)),
            ),
            const SizedBox(height: Dimensions.paddingSmall),

            Text(
              PriceConverter.convertPrice(packages.price),
              style: context.heading.large.strong.overrideWith(color: canSelect ? context.surfaceContainer : const Color(0xff334257)).copyWith(fontSize: 35),
            ),

            Text('${packages.validity}' 'days'.tr, style: context.body.small.regular.overrideWith(color: context.textBaseMedium)),
