...
class _GuestTrackOrderInputViewWidgetState extends State<GuestTrackOrderInputViewWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: ResponsiveHelper.isDesktop(context) ? EdgeInsets.zero : const EdgeInsets.symmetric(horizontal: Dimensions.radiusExtraLarge, vertical: Dimensions.paddingLarge),
          ...
          child: SizedBox(
            ...
            child: Form(
              ...
              child: Column(children: [
                ...
                SizedBox(height: ResponsiveHelper.isDesktop(context) ? 100 : Dimensions.paddingLarge),
