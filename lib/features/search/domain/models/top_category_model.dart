  ...
  TopCategoryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['categories'] != null) {
      ...
      json['categories'].forEach((v) {
        categories!.add(TopCategory.fromJson(v));
      });
    }
  }
...
class TopCategory {
  ...
  TopCategory({this.id, this.name, this.imageFullUrl, this.orderCount, this.slug, this.childes});
  ...
  TopCategory.fromJson(Map<String, dynamic> json) {
    ...
    if (json['childes'] != null) {
      ...
      json['childes'].forEach((v) {
        childes!.add(TopCategoryChild.fromJson(v));
      });
    }
  }
