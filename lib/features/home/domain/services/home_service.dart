...
class HomeService implements HomeServiceInterface {
  ...
  @override
  Future<CategoryCuisineModel?> getCategoryCuisineList({required DataSourceEnum source, String? type, String? name, int? limit, int? offset}) async {
    return await homeRepositoryInterface.getCategoryCuisineList(source: source, type: type, name: name, limit: limit, offset: offset);
  }
