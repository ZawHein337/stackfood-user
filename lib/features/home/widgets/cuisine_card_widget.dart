      ...
      child: Stack(
        children: [
          ...
          Padding(
            ...
            child: Container(decoration: BoxDecoration( color: context.surfaceContainer, borderRadius: BorderRadius.circular(50)),
              child: ClipRRect(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: context.shadow, spreadRadius: 0.5, blurRadius: 0.5)],
                borderRadius: const BorderRadius.only(bottomLeft: Radius.circular(Dimensions.radiusDefault), bottomRight: Radius.circular(Dimensions.radiusDefault)),
              ),
              child: Text( name, style: context.heading.small.medium,
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Text( name, style: context.heading.small.regular,
              maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,
            ),
          ),
        ),
