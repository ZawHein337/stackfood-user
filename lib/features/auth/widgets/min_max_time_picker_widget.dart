    ...
    return Container(
      ...
      child: CarouselSlider.builder(
        ...
        itemBuilder: (context, index, _) {
          return Container(
            decoration: BoxDecoration(
              color: selectedIndex == index ? context.primary.withValues(alpha: 0.1) : Colors.transparent,
            ),
            child: Center(child: Text(
              widget.times[index].toString().tr,
              style: selectedIndex == index ? context.heading.extraLarge.strong : context.body.small.regular,
            )),
          );
        },
      ),
