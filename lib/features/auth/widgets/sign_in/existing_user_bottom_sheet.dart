  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(userModel.name ?? 'Jhon Doe', style: context.subHeading.defaultSize.medium, textAlign: TextAlign.center),
        const SizedBox(height: Dimensions.paddingLarge),

        Text('is_it_you'.tr, style: context.heading.defaultSize.strong, textAlign: TextAlign.center),
        const SizedBox(height: Dimensions.paddingSmall),

        RichText(
          textAlign: TextAlign.center,
          text: TextSpan(children: [
            TextSpan(text: number != null ? 'it_looks_like_the_phone'.tr : 'it_looks_like_the_email'.tr, style: context.body.defaultSize.regular.overrideWith(color: context.textBaseMedium)),
            const TextSpan(text: ' '),

            TextSpan(text: number ?? email, style: context.subHeading.defaultSize.medium.overrideWith(color: context.textBaseDefault)),
            const TextSpan(text: ' '),
