...
class ReviewController extends GetxController implements GetxService {
  ...
  VegType _reviewedType = VegType.all;
  VegType get reviewType => _reviewedType;
  ...
  Future<void> getReviewedProductList(bool reload, VegType type, bool notify, {DataSourceEnum dataSource = DataSourceEnum.local, bool fromRecall = false}) async {
    _reviewedType = type;
