...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    codToDigitalPayment = json['cod_to_digital_payment'] == true || json['cod_to_digital_payment'] == 1;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cod_to_digital_payment'] = codToDigitalPayment;
