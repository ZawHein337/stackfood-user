              ...
              child: CarouselSlider.builder(
                ...
                itemBuilder: (context, index, _) {
                  return Container(
                    ...
                    padding: EdgeInsets.all(Dimensions.paddingSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.paddingSmall))),
                    ...
                    child: Row(children: [
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Row(children: [
                          Flexible(
                            child: Text(
                              ...
                              style: context.subHeading.defaultSize.medium.overrideWith(color: Theme.of(context).textTheme.bodyLarge!.color)
                                  .copyWith(fontSize: Dimensions.fontSizeDefault - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeDefault)), overflow: TextOverflow.ellipsis),
                            ),
                          ),
                          ...
                          InkWell(
                            ...
                            child: Icon(Icons.copy_rounded, size: 16 - (scrollingRate * (isDesktop ? 2 : 16)), color: context.primary),
                          ),
                        ]),
                        SizedBox(height: Dimensions.padding2xSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.padding2xSmall))),
                        ...
                        Text(
                          ...
                          style: context.body.extraSmall.medium.overrideWith(color: context.textBaseMedium)
                              .copyWith(fontSize: Dimensions.fontSizeExtraSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeExtraSmall))),
                        ...
                        Row(children: [
                          Text(
                            ...
                            style: context.body.small.regular.overrideWith(color: context.textBaseMedium)
                                .copyWith(fontSize: Dimensions.fontSizeSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.fontSizeSmall))),
                            maxLines: 1, overflow: TextOverflow.ellipsis,
                          ),
                          SizedBox(width: Dimensions.padding2xSmall - (scrollingRate * (isDesktop ? 2 : Dimensions.padding2xSmall))),
                      ...
                      CustomAssetImageWidget(Images.restaurantCoupon, height: 55 - (scrollingRate * (isDesktop ? 2 : 55)), width: 55),
                    ]),
                  );
                },
              ),
            ...
            Row(
              ...
              children: couponController.couponList!.map((bnr) {
                ...
                return TabPageSelectorIndicator(
                  backgroundColor: index == couponController.currentIndex ? context.primary
