...
class HistoryCartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isDebit = data![index].transactionType == 'order_place' || data![index].transactionType == 'partial_payment' || data![index].transactionType == 'pro_subscription';
    ...
    return Column(children: [
      ...
      index == data!.length-1 ? const SizedBox() : Padding(
        ...
        child: Divider(color: context.surfaceContainerLow)
      ),
