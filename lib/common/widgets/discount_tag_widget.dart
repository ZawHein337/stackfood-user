    ...
    return !isProductBottomSheet ? (discount! > 0 || freeDelivery!) ? Positioned(
        ...
        child: Container(
          ...
          child: Align(
            child: Text(
              ...
              style: context.subHeading.extraSmall.medium.overrideWith(color: Colors.white).copyWith(
      ...
      child: Container(
        ...
        child: Text(
          discount! > 0 ? '${(isRightSide || discountType == 'percent') ? '' : currencySymbol}$discount${discountType == 'percent' ? '%'
              : isRightSide ? currencySymbol : ''} ${'off'.tr}' : 'free_delivery'.tr,
          style: context.subHeading.large.medium.overrideWith(color: context.onSurfaceVariant).copyWith(
