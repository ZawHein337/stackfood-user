...
class Restaurant {
  ...
  bool? verifiedSeller;
  List<String>? tags;
  List<RestaurantCoupon>? coupons;
  bool? isHappyHourRunning;
  bool? ad;
  String? deliveryFee;
  List<RestaurantOffer>? offers;
  bool? isNew;
  ...
  Restaurant.fromJson(Map<String, dynamic> json) {
    ...
    freeDelivery = TypeConvarterHelper.getBoolValue(json['free_delivery']);
    ...
    ratingCount = json['rating_count'] ?? json['reviews_count'];
    ratingCount = json['rating_count'] ?? json['reviews_count'];
    ...
    final dynamic discountJson = json['discount'] ?? json['restaurant_discount'];
    ...
    final dynamic foodsJson = json['foods'] ?? json['top_items'];
    if (foodsJson != null) {
      foods = <Foods>[];
      foodsJson.forEach((v) {
    ...
    distanceMile = json['distance_mile']?.toDouble();
    ...
    final dynamic couponJson = json['coupons'] ?? json['active_coupons'];
    if (couponJson is List) {
      coupons = couponJson.whereType<Map<String, dynamic>>().map((c) => RestaurantCoupon.fromJson(c)).toList();
    }
    isHappyHourRunning = TypeConvarterHelper.getBoolValue(json['is_happy_hour_running']);
    ad = TypeConvarterHelper.getBoolValue(json['ad']);
    isNew = TypeConvarterHelper.getBoolValue(json['is_new']);
    deliveryFee = json['delivery_fee']?.toString();
    if (json['offers'] != null) {
      offers = <RestaurantOffer>[];
      json['offers'].forEach((v) {
        offers!.add(RestaurantOffer.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['distance_mile'] = distanceMile;
    data['distance_label'] = distanceLabel;
    data['verified_seller'] = verifiedSeller;
    data['tag'] = tags;
    if (coupons != null) {
      data['coupons'] = coupons!.map((c) => c.toJson()).toList();
    }
    data['is_happy_hour_running'] = isHappyHourRunning;
    data['ad'] = ad;
    data['is_new'] = isNew;
...
class RestaurantOffer {
  ...
  RestaurantOffer({this.type, this.id, this.name, this.buyQty, this.getQty});

  RestaurantOffer.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    id = json['id'];
    name = json['name'];
    buyQty = json['buy_qty'];
  ...
  Map<String, dynamic> toJson() => {
    'type': type, 'id': id, 'name': name, 'buy_qty': buyQty, 'get_qty': getQty,
  };
}

class RestaurantCoupon {
  int? id;
  String? title;
  String? code;
  double? discount;
  ...
  RestaurantCoupon({
    this.id, this.title, this.code, this.discount, this.discountType,
    this.minPurchase, this.maxDiscount, this.expireDate,
  });

  RestaurantCoupon.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    code = json['code'];
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': title, 'code': code, 'discount': discount,
    'discount_type': discountType, 'min_purchase': minPurchase,
    'max_discount': maxDiscount, 'expire_date': expireDate,
  };
}
...
class Discount {
  ...
  Discount.fromJson(Map<String, dynamic> json) {
    ...
    minPurchase = json['min_purchase']?.toDouble() ?? 0;
    maxDiscount = json['max_discount']?.toDouble() ?? 0;
