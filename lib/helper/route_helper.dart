...
import 'package:stackfood_multivendor/features/bogo_offer/screen/bogo_offer_details_screen.dart';
import 'package:stackfood_multivendor/features/bogo_offer/screen/bogo_offer_screen.dart';
...
import 'package:stackfood_multivendor/features/home/screens/category_cuisine_screen.dart';
...
import 'package:stackfood_multivendor/features/order/screens/all_last_orders_screen.dart';
...
class RouteHelper {
  ...
  static const String allLastOrders = '/all-last-orders';
  static const String profile = '/profile';
  static const String updateProfile = '/update-profile';
  static const String coupon = '/coupons';
  static const String notification = '/notification';
  static const String offer = '/offer';
  static const String bogoOfferScreen = '/bogo-offer';
  static const String bogoOfferDetailsScreen = '/bogo-offer-details';
  ...
  static const String categoryCuisine = '/what-you-need';
  static const String categoryProduct = '/category';
  static const String itemYouWillLove = '/item-you-will-love';
  ...
  static const String locationSuggestion = '/location-suggestion';
  static const String restaurantReview = '/restaurant-review';
  static const String allRestaurants = '/restaurants';
  static const String recommendedRestaurants = '/recommended-restaurants';
  static const String topPickRestaurants = '/top-pick-restaurants';
  static const String quickDeliveryRestaurants = '/quick-delivery-restaurants';
  ...
  static String getOfferRoute() => offer;
  static String getBogoOfferRoute() => bogoOfferScreen;
  static String getBogoOfferDetailsRoute(String idOrSlug) => '$bogoOfferDetailsScreen?id=$idOrSlug';
  ...
  static String getOrderDetailsRoute(int? orderID, {bool? fromOffline, String? contactNumber, bool fromGuestTrack = false, bool fromNotification = false, bool? fromDineIn, String? paymentStatus}) {
    return '$orderDetails?id=$orderID&from_offline=$fromOffline&contact=$contactNumber&from_guest_track=$fromGuestTrack&from_notification=$fromNotification&from_dine_in=$fromDineIn'
        '${paymentStatus != null ? '&status=$paymentStatus' : ''}';
  }
  static String getAllLastOrdersRoute() => allLastOrders;
  ...
  static String getPaymentRoute(OrderModel orderModel, String? paymentMethod, {String? addFundUrl, String? subscriptionUrl, required String guestId, String? contactNumber, int? restaurantId, int? packageId, bool isProSubscription = false, bool isRenew = false, String? codToDigitalUrl}) {
    String data = base64Encode(utf8.encode(jsonEncode(orderModel.toJson())));
    String? codToDigital = (codToDigitalUrl != null && codToDigitalUrl.isNotEmpty) ? base64Encode(utf8.encode(codToDigitalUrl)) : null;
    return '$payment?order=$data&payment-method=$paymentMethod&add-fund-url=$addFundUrl&subscription-url=$subscriptionUrl&guest-id=$guestId&number=$contactNumber&restaurant_id=$restaurantId&package_id=$packageId&is_pro_subscription=$isProSubscription&is_renew=$isRenew&cod-to-digital-url=$codToDigital';
  }
  ...
  static String getCategoryCuisineRoute() => categoryCuisine;
  ...
  static String getItemYouWillLoveRoute() {
    String baseRoute = itemYouWillLove;
    return baseRoute;
  }
  ...
  static String getSetLocationRoute() => locationSuggestion;
  ...
  static String getAllRestaurantRoute(String page) {
    ...
    switch (page) {
      case 'recommended':
        baseRoute = recommendedRestaurants;
        break;
      case 'top_pick':
        baseRoute = topPickRestaurants;
        break;
      case 'quick_delivery':
        baseRoute = quickDeliveryRestaurants;
        break;
  ...
  static String getAiChatDetailsScreen({int? conversationId, String? title, String? initialMessage}) {
    ...
    return '$aiChatDetails?conversation_id=${conversationId ?? 'null'}&title=$encodedTitle&initial_message=$encodedMessage';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: signIn, transition: Transition.downToUp, transitionDuration: const Duration(milliseconds: 300), page: () => SignInScreen(
    ...
    GetPage(name: signUp, transition: Transition.downToUp, transitionDuration: const Duration(milliseconds: 300), page: () => const SignUpScreen()),
    GetPage(name: verification, transition: Transition.downToUp, transitionDuration: const Duration(milliseconds: 300), page: () {
      String? pass;
    ...
    GetPage(name: main, page: () => getRoute(DashboardScreen(
      pageIndex: Get.parameters['page'] == 'home' ? 0 : Get.parameters['page'] == 'order' ? 1
          : Get.parameters['page'] == 'cart' ? 2 : Get.parameters['page'] == 'search' ? 3 : Get.parameters['page'] == 'menu' ? 4 : 0,
    ))),
    GetPage(name: forgotPassword, transition: Transition.downToUp, transitionDuration: const Duration(milliseconds: 300), page: () => ForgetPassScreen()),
    GetPage(name: resetPassword, transition: Transition.downToUp, transitionDuration: const Duration(milliseconds: 300), page: () => NewPassScreen(
    ...
    GetPage(name: offer, page: () => getRoute(Get.arguments)),
    GetPage(name: bogoOfferScreen, page: () => getRoute(const BogoOfferScreen())),
    GetPage(name: bogoOfferDetailsScreen, page: () => getRoute(BogoOfferDetailsScreen(offerIdOrSlug: Get.parameters['id']))),
    ...
    GetPage(name: orderDetails, page: () {
      return getRoute(Get.arguments ?? OrderDetailsScreen(
        ...
        codToDigitalPaymentStatus: (Get.parameters['status'] != null && Get.parameters['status'] != 'null' && Get.parameters['status']!.isNotEmpty)
            ? Get.parameters['status'] : null,
      ));
    }),
    GetPage(name: profile, page: () => getRoute(const ProfileScreen())),
    GetPage(name: updateProfile, page: () => getRoute(const UpdateProfileScreen())),
    GetPage(name: allLastOrders, page: () => getRoute(const AllLastOrdersScreen())),
    ...
    GetPage(name: payment, page: () {
      ...
      String? codToDigitalUrl = (Get.parameters['cod-to-digital-url'] != null && Get.parameters['cod-to-digital-url'] != 'null')
          ? utf8.decode(base64Decode(Get.parameters['cod-to-digital-url']!.replaceAll(' ', '+'))) : null;
      return getRoute(AppConstants.payInWevView ? PaymentWebViewScreen(
        ...
        codToDigitalUrl: codToDigitalUrl,
    ...
    GetPage(name: categoryCuisine, page: () => getRoute(const CategoryCuisineScreen())),
    ...
    GetPage(name: itemYouWillLove, page: () {
    ...
    GetPage(name: cart, transitionDuration: Duration(milliseconds: 300), transition: kIsWeb ? null : Transition.downToUp, page: () => getRoute(CartScreen(fromNav: false, fromReorder: Get.parameters['from_reorder'] == 'true', fromDineIn: Get.parameters['from_dine_in'] == 'true', restaurantId: int.parse(Get.parameters['restaurant_id']!)))),
    ...
    GetPage(name: locationSuggestion, page: () => getRoute(Get.arguments ?? const SetLocationScreen())),
    ...
    GetPage(name: recommendedRestaurants, page: () => getRoute(
    ...
    GetPage(name: topPickRestaurants, page: () => getRoute(
      const AllRestaurantScreen(
        isRecentlyViewed: false,
        isOrderAgain: false,
        isTopPick: true,
    ...
    GetPage(name: quickDeliveryRestaurants, page: () => getRoute(
      const AllRestaurantScreen(
        isRecentlyViewed: false,
        isOrderAgain: false,
    ...
    GetPage(name: allRestaurants, page: () => getRoute(
      AllRestaurantScreen(
        ...
        isRecommended: Get.parameters['page'] == 'recommended',
        isTopPick: Get.parameters['page'] == 'top_pick',
        isQuickDelivery: Get.parameters['page'] == 'quick_delivery',
        isFreeDelivery: Get.parameters['page'] == 'free_delivery',
      ),
    )),
