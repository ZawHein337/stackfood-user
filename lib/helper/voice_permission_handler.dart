...
class VoicePermissionHandler {
  ...
  static void _showPermissionDeniedDialog() {
    showCustomDialog(
      child: DialogSheetBody(child: SizedBox(
          width: 500,
          child: Padding(
                ...
                GetPlatform.isWeb ? SizedBox(
                  ...
                  child: OutlinedButton(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: BorderSide(
                        color: Get.context!.outlineVariant,
                      ),
                    ),
  ...
  static Future<void> openVoiceSearch({required BuildContext context, required TextEditingController searchTextEditingController}) async {
