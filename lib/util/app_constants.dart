...
class AppConstants {
  ...
  static const String categoryCuisineUri = '/api/v1/categories-cuisines';
  ...
  static const String recommendedRestaurantUri = '/api/v1/restaurants/recommended-for-you';
  static const String quickDeliveryRestaurantUri = '/api/v1/restaurants/quick-delivery';
  ...
  static const String happyHourRunningUri = '/api/v1/happy-hour/running';
  static const String happyHourStoreUri = '/api/v1/happy-hour/stores';
  static const String bogoHomeUri = '/api/v1/bogo/home';
  static const String bogoOfferListUri = '/api/v1/bogo/offers';
  static const String restaurantBogoOffersUri = '/api/v1/restaurants/bogo-offers';
  ...
  static const String restaurantPopularItemUri = '/api/v1/products/restaurant-popular-products';
  static const String vehicleChargeUri = '/api/v1/vehicle/extra_charge';
  static const String deliveryChargeCoverageUri = '/api/v1/delivery-charge/coverage-list';
  static const String checkoutSummaryUri = '/api/v1/customer/order/checkout-summary';
  ...
  static const String trendingSearchUri = '/api/v1/trending-searches';
  static const String topCategoriesUri = '/api/v1/categories/top';
  static const String featuredRestaurantUri = '/api/v1/restaurants/featured';
  static const String exclusiveDealsUri = '/api/v1/restaurants/exclusive-deals';
  static const String offerItemsUri = '/api/v1/offers/items';
  static const String offerRestaurantsUri = '/api/v1/offers/restaurants';
  static const String productSearchUri = '/api/v1/products/search';
  ...
  static const String orderDigitalPaymentStatusUri = '/api/v1/customer/order/digital-payment-status';
  static const String orderPayDigitallyUri = '/api/v1/customer/order/pay-digitally';
  static const String codToDigitalCallbackUrl = '$baseUrl/cod-to-digital-callback';
  ...
  static const String cartDiscountEligibilityUri = '/api/v1/customer/cart/discount-eligibility';
  ...
  static const String recentSearchAddress = 'recent_search_address';
  ...
  static const String zipCodeWiseDeliveryCharge = 'zip_code_wise';
  static const String areaWiseDeliveryCharge = 'area_wise';
  static const String distanceWiseDeliveryCharge = 'distance_wise';
  static const String fixedAmountDeliveryCharge = 'fixed_amount';
